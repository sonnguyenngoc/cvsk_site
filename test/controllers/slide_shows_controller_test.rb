...
class SlideShowsControllerTest < ActionController::TestCase
  ...
  test "should create slide_show" do
    assert_difference('SlideShow.count') do
      post :create, slide_show: { description: @slide_show.description, image_url: @slide_show.image_url, title_1: @slide_show.title_1, title_2: @slide_show.title_2 }
    end
  ...
  test "should update slide_show" do
    patch :update, id: @slide_show, slide_show: { description: @slide_show.description, image_url: @slide_show.image_url, title_1: @slide_show.title_1, title_2: @slide_show.title_2 }
    assert_redirected_to slide_show_path(assigns(:slide_show))
  end
